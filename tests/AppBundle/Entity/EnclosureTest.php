...
class EnclosureTest extends TestCase
{
    public function testItHasNoDinosaursByDefault()
    {
        ...
        $this->assertEmpty($enclosure->getDinosaurs());//instead of using assertCount(0, haystack)
    }
    ...
    public function testItDoesNotAllowCarnivorousDinosaursToMixWithHerbivores()
    {
        ...
        $this->expectException(NotABuffetException::class);//this should be add before call the testify situation code.
